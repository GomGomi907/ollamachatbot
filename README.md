...
### 2. 🚀 빠른 시작 (Quick Start)
**원샷 실행 스크립트**를 사용하면 개발 서버와 ngrok을 한 번에 시작할 수 있습니다:
...
이 스크립트는 자동으로:
1. Next.js 개발 서버를 시작 (포트 3000)
2. ngrok 터널을 생성하여 외부 접속 가능하게 설정
3. 각각 별도의 창에서 실행되어 로그 확인 가능

> **참고**: ngrok 창에서 표시되는 `https://...ngrok-free.app` URL을 사용하여 어디서든 접속할 수 있습니다.

### 3. 백엔드 세팅 (Ollama Setup)
